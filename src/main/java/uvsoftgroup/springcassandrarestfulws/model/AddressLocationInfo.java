...
public class AddressLocationInfo {
	...
	@PrimaryKey(value="alId") 
	 Long alId;
	 Long adId,alReferenceId,alThanaCode,alDistictCode;
	 String alDivisionName,alDistictName,alUpzillaOrThanaName,alUnionName,alWardNumber,alBlockNumber;
	 String alSectionNumber,alRoadName,alRoadType,alRoadNumber,alBuildingNumber,alBuildingFloorNumber;
	 String alBuildingFloorUnitNumber,alType,alLocationPic;
